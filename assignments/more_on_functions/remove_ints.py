...
def remove_odds_4(int_list):
    for i, num in enumerate(int_list):
        while i < len(int_list) and int_list[i] % 2 == 1:
            int_list.pop(i)


def remove_odds_5(int_list):
    """Removes odd integers from int_list.
